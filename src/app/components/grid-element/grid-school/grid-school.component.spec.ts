...
describe('GridSchoolComponent', () => {
  ...
  beforeEach(async () => {
    mockAssetServiceSpy = jasmine.createSpyObj('AssetService', [
      'getSchoolIconLocation',
    ]);
    mockAssetServiceSpy.getSchoolIconLocation.and.returnValue(
  ...
  it('should correctly determine an incorrect guess', () => {
    component.guess = mockStudent;
    component.answer = getStudentListTestData()[StudentList.GLOBAL]['Mika'];
    fixture.detectChanges();
  ...
  it('should render school icon image correctly', fakeAsync(() => {
    component.guess = mockStudent;
    fixture.detectChanges();
    fixture.whenStable();
    tick(420);
