...
describe('GridDamageTypeComponent', () => {
  ...
  it('should render the correct damage type text', fakeAsync(() => {
    component.guess = mockStudentAru;
    fixture.detectChanges();
    fixture.whenStable();
    tick(420);
    ...
    expect(spanElement.nativeElement.textContent.trim()).toBe(
      mockStudentAru.damageType
    );
  }));

  it('should correctly format damage type using dashCase pipe', fakeAsync(() => {
    component.guess = mockStudentAru;
    fixture.detectChanges();
    fixture.whenStable();
    tick(420);
    ...
    const divElement = fixture.debugElement.query(By.css('div > div > div'));
    expect(divElement.nativeElement.classList).toContain('explosive');
  }));
