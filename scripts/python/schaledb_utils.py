...
INCONSISTEN_STUDENT_LOOKUP = [
    ...
    ("Asuna (School Uniform)", "Asuna (School)"),
    ("Karin (School Uniform)", "Karin (School)"),
    ("Neru (School Uniform)", "Neru (School)"),
    ("Shun (Kid)", "Shun (Small)"),
    ...
    ("Sumire (Part-Timer)", "Sumire (Part-time Job)"),
